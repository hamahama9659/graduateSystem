							...
							<div class="page-title-box">
								<div class="page-title-right">
									<ol class="breadcrumb m-0">
										...
										<li class="breadcrumb-item"><a href="/user/QnA/list">QnA</a></li>
										...
										<div class="row">
											...
											<div class="col-lg-6">
												<div class="text-sm-right">
													<c:if test="${login.userNo eq qnAVO.userNo}">
...
<script>
	$(document).ready(function() {
		...
		$(".qnaDelete").on("click", function() {
			formObj.attr("action", "/user/QnA/remove");
						...
						$(data)
								.each(
										function() {
											...
											if (loginNo == this.userNo || loginNo == userName)//댓글 정보와 로그인 정보 같을 경우 OR 게시글의 주인 인 경우 댓글 삭제 가능
											{
							...
							$(data)
									.each(
											function() {
												...
												if (loginNo == this.userNo
														|| loginNo == userName)//댓글 정보와 로그인 정보 같을 경우 OR 게시글의 주인 인 경우 댓글 삭제 가능
												{
													strbutton += "<div class='pull-right hidden-phone'>"
															+ "  <a href='#' onclick='deleteReply("
															+ this.replyNo
