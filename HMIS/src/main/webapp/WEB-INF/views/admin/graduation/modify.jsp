							...
							<div class="page-title-box">
								<div class="page-title-right">
									<ol class="breadcrumb m-0">
										...
										<li class="breadcrumb-item active">졸업심사 글 수정</li>
									</ol>
								</div>
								<h4 class="page-title">졸업심사 글 수정</h4>
							</div>
						</div>
					</div>
							...
							<div class="row" style="justify-content: center;">
										...
										<div class="card-body">
											...
											<form role="form" onsubmit="return validate();" method="post">
												...
												<div class="row">
													...
													<div class="form-group mb-3">
														<label for="graduState" class="col-3 col-form-label">마감
															상태</label> <select class="form-control select2" name="graduState"
															id="graduState">
															<option value="신청대기"
																<c:out value="${graduationVO.graduState eq '신청대기'?'selected':'' }"/>>신청대기</option>
															<option value="모집중"
																<c:out value="${graduationVO.graduState eq '모집중'?'selected':'' }"/>>모집중</option>
															<option value="마감"
																<c:out value="${graduationVO.graduState eq '마감'?'selected':'' }"/>>마감</option>
                              ...
                              <input type="hidden" class="form-control" name="keyword" value="${cri.keyword}"> --%>
											...
											<div class="row mt-4">
												<div class="col-sm-6">
													<a
														href="/admin/graduation/list?searchType=${cri.searchType}&keyword=${cri.keyword}&page=${cri.page}&perPageNum=${cri.perPageNum}"
