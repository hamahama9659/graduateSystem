							...
							<div class="page-title-box">
								<div class="page-title-right">
									<ol class="breadcrumb m-0">
										...
										<li class="breadcrumb-item"><a href="/admin/apply/list">자격증관리</a></li>
										<li class="breadcrumb-item active">자격증관리</li>
									</ol>
								</div>
								<h4 class="page-title">자격증관리 상세보기</h4>
							</div>
						</div>
					</div>
					<!-- end page title -->
					...
					<form role="form">
						...
						<div class="row">
							<div class="col-12">
								...
								<div class="card">
									<div class="card-body">
										<h4 class="header-title">자격증관리 상세보기</h4>
