                     ...
                     <div class="page-title-box">
                        <div class="page-title-right">
                           <ol class="breadcrumb m-0">
                              ...
                              <li class="breadcrumb-item active">관리자 프로그램 승인/거절</li>
                           </ol>
                        </div>
                        <h4 class="page-title">관리자 프로그램 승인/거절</h4>
                     </div>
                  </div>
               </div>
               <!-- end page title -->
                                 ...
                                 <form class="form-inline">
                                    <div class="form-group mx-sm-3 mb-2">
                                       <select class="custom-select" id="status-select"
                                          ...
                                          <option value="nn"
                                             <c:out value="${cri.searchType eq 'nn'?'selected':''}"/>>학번
                                             또는 이름</option>
                                       </select>
                                    </div>
