...
<div class="navbar-custom topnav-navbar topnav-navbar-dark">
    <div class="container-fluid">
        ...
        <!-- LOGO -->
        <a href="/user/main" class="topnav-logo">
            <span class="topnav-logo-lg">
                <img
            src="/resources/dist/assets/images/hmis_logo.png" alt="" height="25"
            id="">
            </span>
        ...
        <ul class="list-unstyled topbar-right-menu float-right mb-0">
            ...
            <li class="dropdown notification-list">
                <a class="nav-link dropdown-toggle nav-user arrow-none mr-0" data-toggle="dropdown" id="topbar-userdrop"
                    ...
                    <span class="account-user-avatar"   style="font-weight: bolder;" >
                        <img src="/resources/dist/assets/images/users/avatar-1.jpg" alt="user-image" class="rounded-circle">
                       ${login.userName} 님
                        <div id="state" style="padding-left:50px; font-size: 0.2em;">${login.state} 중</div>
                       </span>
                        <%--  <span class="account-user-name">${login.userName} 님</span>
                        <span class="account-position">${login.state} 중</span>
                    </span>
                    <span>
                        <span class="account-user-name">${login.userName} 님</span>
                        <span class="account-position">${login.state} 중</span>
